    <header class="page-header gradient">
      <div class="container pt-3">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-5">
            <h2>Pagina hecha por Desarroladores web de JS Studios</h2>

            <p>
            Está pagina esta creada y sustentada por los estudiantes de Programación de software donde se observaran datos, Proyectos e información de nuestros servicios.
            </p>
